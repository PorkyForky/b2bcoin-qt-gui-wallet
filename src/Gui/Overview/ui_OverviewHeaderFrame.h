...
public:
    ...
    void retranslateUi(QFrame *OverviewHeaderFrame)
    {
        ...
        m_overviewPoolSizeLabel->setText(QApplication::translate("OverviewHeaderFrame", "0", 0));
        label_9->setText(QApplication::translate("OverviewHeaderFrame", "Pending TX's in network", 0));
