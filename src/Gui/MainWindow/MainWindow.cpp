...
const char COMMUNITY_FORUM_URL[] = "https://t.me/joinchat/Fxlb2Qw8ivAta7iYgM0Wiw";
const char REPORT_ISSUE_URL[] = "https://t.me/joinchat/Fxlb2Qw8ivAta7iYgM0Wiw";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("B2Bcoin QT GUI Wallet %1").arg(Settings::instance().getVersion()));
