...
#ifdef Q_OS_MAC
  return QIcon(":images/b2bcoin_mac");
#elif defined(Q_OS_LINUX)
  return QIcon(":images/b2bcoin_lin");
#elif defined(Q_OS_WIN)
  return QIcon(":images/b2bcoin_win");
#endif
}
...
QString Style::makeStyleSheet(const QString& _styleSheetTemplate) const {
  ...
  return styleSheet.
    ...
    replace("%toolButtonFontColorHover%", toolButtonFontColorHover()).
